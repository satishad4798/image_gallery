  ...
  .img-fluid{
    ...
    <div class="container">
      ...
      <div class="row no-gutters" id="lightgallery">
        ...
        ?>
        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item" style="background-color: grey;" data-aos="fade" data-src="admin/images/<?php echo $row['img'];?>" data-sub-html="<h4>Your loving memories.</p>">
